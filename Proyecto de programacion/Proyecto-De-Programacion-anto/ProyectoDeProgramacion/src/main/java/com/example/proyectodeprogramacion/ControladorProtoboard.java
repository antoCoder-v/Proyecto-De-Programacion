...
public class ControladorProtoboard {
    ...
    private Button botonPresionado;  // Almacena el botón presionado
    ...
    // Método que agrega botones a un GridPane 
    private void agregarBotonesGridPane(GridPane gridPane, String tipo) {
        ...
        for (int row = 0; row < rows; row++) {
            for (int col = 0; col < columns; col++) {
                ...
                // Asignar un ID basado en la posición y el tipo de botón
